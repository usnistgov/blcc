...
export function ResultsSwitch({ ...defaultProps }) {
    ...
    const onChange = (e: RadioChangeEvent) => {
        e.target.value === "discounted"
            ? ResultModel.setDiscountedCashFlow(true)
            : ResultModel.setDiscountedCashFlow(false);
    };
    ...
    return (
        <div className="w-1/5">
            ...
            <Radio.Group
                onChange={onChange}
                defaultValue={discountedCashFlow ? "discounted" : "non-discounted"}
                buttonStyle="solid"
            >
