...
namespace Model {
	...
	export const initialCost = new Var(
		CostModel.cost,
		costOptic.prop("initialCost"),
	);
	export const initialOccurrence = new Var(
		CostModel.cost,
		costOptic.prop("initialOccurrence"),
	);
	export const annualRateOfChange = new Var(
		CostModel.cost,
		costOptic.prop("annualRateOfChange"),
	);
		...
		<div className={"max-w-screen-lg p-6"}>
			<div className={"grid grid-cols-3 gap-x-16 gap-y-4"}>
				<TestNumberInput
					...
					label={
						isSavings
							? "Initial Cost Savings (Base Year Dollars)"
